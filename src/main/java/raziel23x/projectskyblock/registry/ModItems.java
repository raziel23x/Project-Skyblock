...
public final class ModItems {
    ...
    public static final DeferredItem<ArmorItem> FLINT_HELMET = armor("flint_helmet", ModArmorMaterials.FLINT, ArmorItem.Type.HELMET, 110);
    public static final DeferredItem<ArmorItem> FLINT_CHESTPLATE = armor("flint_chestplate", ModArmorMaterials.FLINT, ArmorItem.Type.CHESTPLATE, 160);
    public static final DeferredItem<ArmorItem> FLINT_LEGGINGS = armor("flint_leggings", ModArmorMaterials.FLINT, ArmorItem.Type.LEGGINGS, 150);
    public static final DeferredItem<ArmorItem> FLINT_BOOTS = armor("flint_boots", ModArmorMaterials.FLINT, ArmorItem.Type.BOOTS, 130);

    public static final DeferredItem<ArmorItem> WOODEN_HELMET = armor("wooden_helmet", ModArmorMaterials.WOODEN, ArmorItem.Type.HELMET, 110);
    public static final DeferredItem<ArmorItem> WOODEN_CHESTPLATE = armor("wooden_chestplate", ModArmorMaterials.WOODEN, ArmorItem.Type.CHESTPLATE, 160);
    public static final DeferredItem<ArmorItem> WOODEN_LEGGINGS = armor("wooden_leggings", ModArmorMaterials.WOODEN, ArmorItem.Type.LEGGINGS, 150);
    public static final DeferredItem<ArmorItem> WOODEN_BOOTS = armor("wooden_boots", ModArmorMaterials.WOODEN, ArmorItem.Type.BOOTS, 130);
    ...
    private static DeferredItem<ArmorItem> armor(String name,
                                                  ...
                                                  ArmorItem.Type type,
                                                  int durability) {
        return ITEMS.register(name, () -> new ArmorItem(material, type, new Item.Properties().durability(durability)));
    }
